...
def sentinel_timeseries(roi=None, start_year=2015, end_year=2019, start_date='01-01', end_date='12-31'):
    ################################################################################
    ...
    # Get Sentinel 2 surface reflectance collections for MSI, Level-2A
    ...
    '''>>Double check quality (cloud shadow from SLC)'''

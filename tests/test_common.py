...
class CommonTest(unittest.TestCase):
    ...
    def test_show_html(self):
        ...
        with mock.patch("os.path.exists", return_value=True):
            with mock.patch(
                "builtins.open",
                mock.mock_open(read_data="<html>test file content</html>"),
            ):
    ...
    @unittest.skipUnless(
        importlib.util.find_spec("xee") is not None
        and importlib.util.find_spec("shapely") is not None,
        "xee and shapely are required for ee_to_xarray legacy-grid conversion tests",
    )

...
40. How to add interactive widgets to the map (video | [gif](https://i.imgur.com/peRZZjj.gif) | [notebook](https://github.com/giswqs/geemap/blob/master/examples/notebooks/40_ipywidgets.ipynb))

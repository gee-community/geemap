...
57. Creating publication-quality maps with multiple Earth Engine layers (video | gif | [notebook](https://geemap.org/notebooks/57_cartoee_blend))
58. Using shapefile, GeoJSON, and KML with geemap (video | gif | [notebook](https://geemap.org/notebooks/58_shp_kml))
